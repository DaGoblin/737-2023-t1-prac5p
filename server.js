...
const subtract = (num1, num2) => {
  const result = num1 - num2;
  logger.debug(`subtract called num1 = ${num1}, num2 = ${num2}, Result ${result}`);
  return result;
};

const divide = (num1, num2) => {
  const result = num1 / num2;
  logger.debug(`divide called num1 = ${num1}, num2 = ${num2}, Result ${result}`);
  return result;
};

const multiply = (num1, num2) => {
  const result = num1 * num2;
  logger.debug(`multiply called num1 = ${num1}, num2 = ${num2}, Result ${result}`);
  return result;
};
